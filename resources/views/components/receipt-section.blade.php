<section class="section">
        ...
        <table class="total-section__table">
            <thead class="total-section__thead">
                <tr class="total-section__row">
                    ...
                    <th class="total-section__cell total-section__cell--total">{{ $payment['amounts']['total'] }}</th>
                </tr>
            </thead>
            <tbody>
                <tr class="total-section__row">
    ...
    <div class="payment-details-section">
        ...
        <div class="payment-details-section__notes-container">
            ...
            <p class="payment-details-section__notes--text">{{ $payment['notes'] ? $payment['notes'] : 'Sin notas' }}
            </p>
        </div>
    </div>
