<section class="section">
        ...
        <table class="header-section__info">
            <tr class="header-section__titles">
                ...
                <td class="header-section__folio">
                    ...
                    <p class="header-section__subtitle">Adicional</p>
    ...
    <section class="detail-section">
        ...
        <table class="details-section__table">
            ...
            <tbody>
                <tr class="details-section__row">
                    <td class="details-section__row--body">{{ $payment['concept'] }}</td>
                    <td class="details-section__row--body">{{ $payment['subtotal'] }}</td>
                    <td class="details-section__row--body">{{ $payment['vat'] }}</td>
                    <td class="details-section__row--body">{{ $payment['total'] }}</td>
                </tr>
            </tbody>
        </table>
    </section>
    ...
    <div class="payment-details-section">
        ...
        <table class="payment-details-section__table">
            ...
            <tbody class="payment-details-section__tbody">
                <tr class="payment-details-section__row">
                    <td class="payment-details-section__row--body">{{ $payment['payment_type_name'] }}</td>
                    <td class="payment-details-section__row--body">{{ $payment['payment_date'] }}</td>
                </tr>
            </tbody>
        </table>
